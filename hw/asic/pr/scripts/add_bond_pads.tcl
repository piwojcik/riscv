# This script adds given bond pad to all I/O cells in the chip.

set mtm_io_pad PAD70N_DS
set mtm_io_lib tpfn40lpgv2od3wc1
...
set io_cell_names [get_db [get_lib_cells $mtm_io_lib/*] .base_name]

# search all the design to find the io cells by the name
foreach io_cell_name $io_cell_names {
  set design_io_cells [get_cells -hier -filter "@ref_lib_cell_name == $io_cell_name"]

  foreach_in_collection io_cell $design_io_cells {
      ...
      set io_inst \\${io_cell_name}${mtm_bond_pad_suffix}\
